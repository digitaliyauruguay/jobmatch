 ...
 * Qué hace: Página para que la empresa edite una oferta existente.
 * Validación campo por campo en orden, RequiredLabel con asterisco,
 * mensajes con ícono y auto-dismiss de 4 segundos, y feedback de
 * procesando/éxito en el botón de guardar.
...
export default function EditJobPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [jobRes, catsRes] = await Promise.all([
      ...
      <div className="bg-jm-card border border-jm-border rounded-2xl p-6 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea value={form.description}
            ...
            rows={4} placeholder="Describí las tareas, requisitos y condiciones del puesto..." />
        </div>
