/*
 * Archivo: src/components/ui/CompanyNavbar.tsx
 * Qué hace: Navbar flotante compartida para todas las páginas del
 * dashboard de empresa. Hace su propio fetch del perfil (logo, nombre)
 * para mostrarlo de forma consistente en cualquier página, junto con
 * notificaciones y botón de salir. Refresca la sesión cada 15 segundos
 * para detectar bloqueos/desactivaciones y forzar logout automático.
 */
    ...
    <div className="sticky top-0 z-40 px-4 pt-4 pb-2 bg-jm-black">
      <nav className="max-w-7xl mx-auto bg-jm-card/90 backdrop-blur-md border border-jm-border rounded-2xl">
        <div className="px-5 py-3 flex justify-between items-center">
          <Link href="/company/dashboard" className="flex items-center gap-2 cursor-pointer group">
            <IconBriefcase
              size={22}
          ...
          <div className="flex items-center gap-4">
            <Link href="/company/profile/edit" className="flex items-center gap-3 cursor-pointer group">
              {profile?.logo ? (
                <img
                  src={profile.logo}
                  alt="Logo de empresa"
